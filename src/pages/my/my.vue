	...
	<view class="container">
			<view class="user-section">
				...
				<view class="user-info-box">
					...
					<view class="btn-login-out" v-if="hasLogin" @click.stop="loginOut"  >
						(退出)
					</view>
				</view>
				<view class="vip-card-box" @click="login">
				...
				<!--  -->
					...
					<view class="history-section icon">
						...
						<scroll-view scroll-x class="h-list">
							<image @click="navTo('/pages/product/product')" :src="defaultImage" mode="aspectFill"></image>
							<image @click="navTo('/pages/product/product')" :src="defaultImage" mode="aspectFill"></image>
							<image @click="navTo('/pages/product/product')" :src="defaultImage" mode="aspectFill"></image>
							<image @click="navTo('/pages/product/product')" :src="defaultImage" mode="aspectFill"></image>
							<image @click="navTo('/pages/product/product')" :src="defaultImage" mode="aspectFill"></image>
...
<script lang="ts" setup>
	...
	const defaultImage = ref('https://ts1.cn.mm.bing.net/th/id/R-C.16285d60bfd86c504b91c009a4bdf524?rik=wiKv8twYGbCjag&riu=http%3a%2f%2fwww.dianshu119.com%2fuploads%2f201403%2f1393726246SbLdkisO.jpg&ehk=wcKglAHa6EvAxReKCus%2bf5bNq%2b9%2baDusdQKDqkKX%2fHQ%3d&risl=&pid=ImgRaw&r=0')
