<template>
  <view>
    ...
    <!-- 分享 -->
    <share ref="share" :content-height="580" :share-list="shareList"></share>
  </view>
</template>

<script>
import { getDetailApi, getShareListApi } from '@/api.js'
...
export default {
  ...
  async onLoad(options) {
    const detailData = await getDetailApi()
    const shareList = await getShareListApi()
