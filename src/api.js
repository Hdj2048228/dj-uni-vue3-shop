...
const goodsList = [
  ...
  },
  {
    ...
    image2: 'http://img.zcool.cn/community/017a4e58b4eab6a801219c77084373.jpg',
...
export const getLazyLoadApi = () => Api(lazyLoadList)
export const getShareListApi = () => Api(shareList)
export const getGoodListApi = () => Api(goodsList)
export const getOrderListApi = () => Api(orderList)
export const getCateApi = () => Api(cateList)
